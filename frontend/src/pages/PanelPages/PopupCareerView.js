         ...
         <div className="popupform1">
            <div className="row">
                <div className="col-sm-12">
                     <p className="arabic-style">{data.data.Gender}</p>
            <p className="arabic-style">{data.data.Email}</p>
            <p className="arabic-style">{data.data.Phone}</p>
            <p className="arabic-style">{data.data.Nationality}</p>
...
export default PopupCareerView;