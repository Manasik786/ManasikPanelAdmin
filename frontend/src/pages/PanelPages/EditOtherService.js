...
export default function EditOtherService() {
    const Stylings = {
        color: "white",
        textDecoration: "none",
    };
    ...
    const createProductSubmitHandler = async (e) => {
        ...
        myForm.append("CardType", CardType);
    ...
    //{"flag":true,"_id":"62d52e7e23b2fa38448f747c","CardType":CardType,"CardTitle":"Good Service","CardDescriptions":"lorem ipsum",
