    ...
    const createProductSubmitHandler = async (e) => {
        ...
        try {
            ...
            const response = await axios.put(
                `/api/v1/AirAmbulance/${preditdata._id}`, myForm
            );
    ...
    return (
        <div className="productList">
            ...
            <div className="contentbox">
                <h5>Service Title</h5>
                <input type="text" name="CardDetail" value={data.CardDetail} placeholder={preditdata.CardDetail} onChange={handleChange} />
