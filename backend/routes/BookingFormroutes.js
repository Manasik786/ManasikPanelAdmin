...
const { SendComplaintLead, GetBookingFormItems, CreateBookingFormList, UpdateBookingFormItems, DeleteBookingFormItems ,SendLength} = require("../controller/BookingFormController")
...
router.route("/length").get(SendLength)
