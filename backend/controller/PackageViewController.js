...
exports.CreatePackageViewSchemaList = catchAsyncErrors(async (req, res, next) => {
    // let images = [];
...
exports.DeletePackageViewSchemaItems = catchAsyncErrors(async (req, res, next) => {
...
exports.UpdatePackageViewSchemaItems = catchAsyncErrors(async (req, res, next) => {
