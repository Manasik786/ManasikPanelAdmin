...
exports.CreateGalleryList = catchAsyncErrors(async (req, res, next) => {
    let images = [];
...
exports.GetGalleryItems = catchAsyncErrors(async (req, res, next) => {
...
exports.DeleteGalleryItems = catchAsyncErrors(async (req, res, next) => {
    const data = await GallerySchema.findById(req.params.id)
    if (!data) {
...
exports.UpdateGalleryItems = catchAsyncErrors(async (req, res, next) => {
    let data = await GallerySchema.findById(req.params.id)
    ...
    data = await GallerySchema.findByIdAndUpdate(req.params.id, req.body, {
        new: true,
        runValidators: true,
