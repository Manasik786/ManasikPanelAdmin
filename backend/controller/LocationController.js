...
exports.CreateLocationList = catchAsyncErrors(async (req, res, next) => {
    // let images = [];
    ...
    const data = await LocationSchema.create(req.body);
...
exports.DeleteLocationItems = catchAsyncErrors(async (req, res, next) => {
    const data = await LocationSchema.findById(req.params.id)
    if (!data) {
...
exports.UpdateLocationItems = catchAsyncErrors(async (req, res, next) => {
    let data = await LocationSchema.findById(req.params.id)
    // const { Position, Name, Phone, Email, Gender, Nationality, CV, Applied } = req.body
    ...
    //     req.body.images = imagesLinks;
    // }
    data = await LocationSchema.findByIdAndUpdate(req.params.id, req.body, {
        new: true,
        runValidators: true,
